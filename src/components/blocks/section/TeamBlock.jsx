...
const TeamBlock = ({ block }) => {
	...
	return (
		<div className="m-0 flex h-full w-full justify-center bg-black py-6 ">
			<div className="flex w-11/12 flex-col rounded-[.5em] bg-gradient-to-r from-blue-200/10 to-blue-200/5 p-8 shadow-lg md:w-1/2 lg:w-1/3">
					...
					{block.team?.image && (
						<div className="flex items-center">
							{/* <img
								...
								className=" h-[5em] w-[5em] max-h-[5em] max-w-[5em] object-cover cover rounded-[.8em] "
							/> */}
				...
				<p className="text-md  bg-gradient-to-r from-blue-100/75 to-blue-100/60 bg-clip-text pt-4 leading-6   text-transparent">
					{block?.team.shortBio}
				</p>
