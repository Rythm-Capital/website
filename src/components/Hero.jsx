...
import SplineScene from './SplineScene'; // Ensure this path is correct

const Hero = () => (
    <div className='flex h-screen w-full flex-col items-center justify-center'>
        <div className="w-full h-screen absolute">
            <SplineScene client:load />
        </div>
        <div className="relative z-10 flex justify-center items-center flex-col">
            <h1
                className='heading-text block flex w-auto text-balance text-center text-[5rem] leading-[.9em] uppercase tracking-wide md:text-[7rem]'
            >
                Trading
            </h1>
            <h1
                className='heading-text block flex w-auto text-balance text-center text-[5rem] leading-[.9em] uppercase tracking-wide md:text-[6rem]'
            >
                Gamified
            </h1>
            <div className='flex w-full flex-col items-center justify-center'>
                <h2
                    className='primary-text w-3/4 text-balance py-6 text-center text-xl text-gray-200 md:w-1/2 md:text-[1.25rem]'
                >
